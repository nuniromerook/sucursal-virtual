...
export default function BottomNavbarAdmin() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-white/95 backdrop-blur-md border-t border-neutral-200 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] px-2 py-1.5 transition-all">
      <div className="flex items-center justify-around max-w-lg mx-auto">
        ...
        >
          <div className="relative">
            <div className={`size-10 -mt-3.5 rounded-full flex items-center justify-center shadow-md active:scale-95 transition-transform ${
              isOrders
        ...
        >
          ...
          <span className="text-[11px] mt-1 tracking-tight">KDS TV</span>
        </Link>
        ...
        >
          ...
          <span className="text-[11px] mt-1 tracking-tight">Sucursal</span>
        </Link>
      </div>
    </div>
  );
